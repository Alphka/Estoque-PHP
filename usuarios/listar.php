...
<html lang="pt-BR">
	<head>
		...
		<title>Lista de usuários - Estoque</title>
		...
		<main>
			<header class="pt-8">
				<hgroup class="flex flex-col text-center gap-2">
					<h1 class="text-3xl font-bold leading-none">Lista de usuários</h1>
				</hgroup>
			</header>
					...
					columns: [
						...
						{ title: "Ações", width: 108, headerSort: false, formatter: cell => (
							'<div class="flex items-center justify-center gap-1.5">' +
								...
								`<form action="../api/usuarios/excluir.php?id=${cell.getRow().getData().id}" method="POST" onsubmit="handleDeleteFormSubmit.call(this, event, '${cell.getRow().getData().id}')">` +
